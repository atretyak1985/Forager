...
func main() {
	...
	fs.StringVar(&listen, "listen", envOr("FORAGER_LISTEN", "127.0.0.1:8090"), "listen address for serve mode")
...
flags (after the command):
  ...
  -listen ADDR     serve listen address    (env FORAGER_LISTEN, default 127.0.0.1:8090)
